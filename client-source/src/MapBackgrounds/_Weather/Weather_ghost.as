...
package MapBackgrounds._Weather {
  ...
  public class Weather_ghost extends Background {

    public var _P_j:Vector.<GhostDrop>;
    protected var graphicsData_:Vector.<IGraphicsData>;
    private var time:int;

    public function Weather_ghost(){
      this._P_j = new Vector.<GhostDrop>();
    ...
    private function addGhostDrop():void{
      var _local1:_kp = AssetLibrary._18("ghosts");
      var _local2:GhostDrop = new GhostDrop(((Math.random() * 1000) - 500), ((Math.random() * 1000) - 500), (3 * (0.5 + (0.5 * Math.random()))), _local1._W_u[int((_local1._W_u.length * Math.random()))]);
      _local2.x_spd = 3.5;
      _local2.y_spd = 3.5;
...
class GhostDrop {
  ...
  public function GhostDrop(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:BitmapData):void{
