...
class SetGiveContainerUI extends Frame {

  public static var isClosed:Boolean = true;
  public var open:Boolean;

  public function SetGiveContainerUI(param1:GameSprite, param2:GameObject) {
    SetGiveContainerUI.isClosed = false;
    super("Give Sets", "Craft", "Close", "/craft", 250);
