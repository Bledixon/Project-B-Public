...
{	
	...
	import gif.frames.GIFFrame;
	import gif.decoder.GIFDecoder;
	import gif.events.GIFPlayerEvent;
	import gif.events.FrameEvent;
	import gif.events.TimeoutEvent;
	import gif.events.FileTypeEvent;
	import gif.errors.FileTypeError;
