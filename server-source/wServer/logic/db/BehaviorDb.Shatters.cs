    ...
    partial class BehaviorDb
    {
        ...
        .Init("shtrs Lava Souls",
            ...
            new State(
                ...
                new State("1st",
                    ...
                    new Shoot(20, projectileIndex: 1, count: 4, angleOffset: 10, coolDown: 2500),
        ...
        #region 1stboss
            .Init("shtrs Bridge Sentinel",
                new State(
                    new Shoot(2, projectileIndex: 5, count: 6, fixedAngle: 0, coolDown: 500),
        ...
        #region blobomb
            .Init("shtrs Blobomb",
                new State(
                    new State("active",
                        new Follow(.7, range: 0),
                        new PlayerWithinTransition(0.2, "blink")
                    ),
                    new State("blink",
                        new Flash(0xfFF0000, flashRepeats: 10000, flashPeriod: 0.1),
                        new TimedTransition(2000, "explode")
        ...
        .Init("shtrs Spawn Bridge",
            new State(
                new State("Idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true),
                    new EntityNotExistsTransition("shtrs Bridge Sentinel", 10, "Open")
                    ),
                new State("Open",
        ...
        #region 3rdboss
            .Init("shtrs The Forgotten King",
                new State(
                    ...
                    new State("red",
                        ...
                        new State("Pause",
                            //new ConditionalEffect(ConditionEffectIndex.Invincible),
                            new TimedTransition(2000, "littlerage")
                            ),
                        new State("MoveTo",
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                            new MoveTo(0, -8, 0.5),
            ...
            .Init("shtrs Royal Guardian J",
                new State(
                    new State("shoot",
                        new Orbit(0.5, 3.5, 5, "shtrs The Forgotten King"),
