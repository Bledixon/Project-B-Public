    ...
    partial class BehaviorDb
    {
        private _ Crystal = () => Behav()
            .Init("Mysterious Crystal",
                new State(
                    new State("Idle",
                        new Taunt(0.05, "Break the crystal for great rewards..."),
                        new Taunt(0.05, "Help me..."),
                        new HpLessTransition(0.9999, "Instructions"),
                        new TimedTransition(10000, "Idle")
                        ),
                    new State("Instructions",
                        new Flash(0xffffffff, 2, 100),
                        new Taunt(0.5, "Fire upon this crystal with all your might for 5 seconds"),
                        new Taunt(0.5, "If your attacks are weak, the crystal magically heals"),
                        new Taunt(0.5, "Gather a large group to smash it open"),
            ...
            .Init("Crystal Prisoner",
                ...
                new Threshold(0.0001,
                    ...
                    new ItemLoot("Shield1", 0.002),
                    new ItemLoot("Shield2", 0.002),
                    new ItemLoot("Shield3", 0.002),
                    new ItemLoot("Crystal Wand", 0.01),
                    new ItemLoot("Crystal Sword", 0.01),
                    new ItemLoot("Snowman Armor", 0.005),
                ...
                new State(
                    ...
                    new State("attack",
                        ...
                        new State("go_anywhere",
                            ...
                            new TimedTransition(2000, "go away")
                           ),
                        new State("go away",
                                  new Suicide()
                            )
