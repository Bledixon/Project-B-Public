...
namespace terrain
{
    ...
    internal class PolygonMap
    {
        ...
        {
            var lake = new HashSet<MapPolygon>(Polygons.Where(_ => _.IsWater));
        ...
        {
            var sorted = new List<double>(nodes.Select(_ => _.DistanceToCoast.Value).Distinct());
            sorted.Sort();
